...
static const _TargetCall_Request_type_support_symbol_names_t _TargetCall_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fun5mini_interfaces, srv, TargetCall_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fun5mini_interfaces, srv, TargetCall_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, fun5mini_interfaces, srv, TargetCall_Request)() {
  return &::fun5mini_interfaces::srv::rosidl_typesupport_c::TargetCall_Request_message_type_support_handle;
}
...
static const _TargetCall_Response_type_support_symbol_names_t _TargetCall_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fun5mini_interfaces, srv, TargetCall_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fun5mini_interfaces, srv, TargetCall_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, fun5mini_interfaces, srv, TargetCall_Response)() {
  return &::fun5mini_interfaces::srv::rosidl_typesupport_c::TargetCall_Response_message_type_support_handle;
}
...
static const _TargetCall_type_support_symbol_names_t _TargetCall_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fun5mini_interfaces, srv, TargetCall)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fun5mini_interfaces, srv, TargetCall)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, fun5mini_interfaces, srv, TargetCall)() {
  return &::fun5mini_interfaces::srv::rosidl_typesupport_c::TargetCall_service_type_support_handle;
}
