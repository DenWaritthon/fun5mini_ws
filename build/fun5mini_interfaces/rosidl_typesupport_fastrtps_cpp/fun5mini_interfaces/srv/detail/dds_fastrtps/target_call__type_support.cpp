...
#include "fun5mini_interfaces/srv/detail/target_call__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fun5mini_interfaces::srv::TargetCall_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fun5mini_interfaces::srv::TargetCall_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fun5mini_interfaces::srv::TargetCall_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TargetCall_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const fun5mini_interfaces::srv::TargetCall_Request *>(
...
static size_t _TargetCall_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TargetCall_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TargetCall_Request__callbacks = {
...
static rosidl_message_type_support_t _TargetCall_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TargetCall_Request__callbacks,
...
{
  return &fun5mini_interfaces::srv::typesupport_fastrtps_cpp::_TargetCall_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = fun5mini_interfaces::srv::TargetCall_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fun5mini_interfaces::srv::TargetCall_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<fun5mini_interfaces::srv::TargetCall_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TargetCall_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const fun5mini_interfaces::srv::TargetCall_Response *>(
...
static size_t _TargetCall_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TargetCall_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TargetCall_Response__callbacks = {
  "fun5mini_interfaces::srv",
  "TargetCall_Response",
...
static rosidl_message_type_support_t _TargetCall_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TargetCall_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &fun5mini_interfaces::srv::typesupport_fastrtps_cpp::_TargetCall_Response__handle;
}
...
static service_type_support_callbacks_t _TargetCall__callbacks = {
  "fun5mini_interfaces::srv",
  "TargetCall",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fun5mini_interfaces, srv, TargetCall_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fun5mini_interfaces, srv, TargetCall_Response)(),
...
static rosidl_service_type_support_t _TargetCall__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TargetCall__callbacks,
...
{
  return &fun5mini_interfaces::srv::typesupport_fastrtps_cpp::_TargetCall__handle;
}
